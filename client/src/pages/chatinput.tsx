    ...
    return (
        <div className="flex items-center p-4 bg-white border-t border-gray-400 max-w-4xl">
            ...
            <input
                ...
                className="hidden"
            />
            <button className="text-green-800 px-4 py-2 rounded-lg" onClick={handleFileInputClick}>
                <FontAwesomeIcon icon={faPaperclip} />
            </button>
            <button className="text-green-800 px-4 py-2 rounded-lg ml-2" onClick={handleSendButtonClick}>
