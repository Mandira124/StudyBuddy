...
const Home2 = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-between w-full md:w-11/12 mx-auto p-6 bg-white rounded-lg shadow-lg space-y-6 md:space-y-0 md:space-x-10 min-h-screen">
      <img
        src={home}
        alt="Home"
      ...
      <div className="flex flex-col w-full md:w-1/2 space-y-6 text-center md:text-left items-center md:items-start">
        <p className="text-3xl md:text-5xl lg:text-6xl font-bold w-full md:w-3/4">
